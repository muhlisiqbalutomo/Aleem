...
const DzikirPetang = ({navigation}) => {
  return (
    <View style={styles.container}>
      <Header title="Dzikir Petang" onPress={() => navigation.goBack()} />
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          {JSONDzikir.petang.map(item => {
            return (
              <View key={item.id}>
          ...
          <Text style={styles.sumber}>
            https://arofta.id/dzikir-sore-lengkap-sesuai-al-quran-dan-as-sunnah/
          </Text>
        </View>
      </ScrollView>
    </View>
